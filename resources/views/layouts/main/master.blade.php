   ...
   <body>
      ...
      <div class="page-wraper">
         ...
         @php
             ...
             $zaloDigits = preg_replace('/\D+/', '', $hotlineNumber);
             $zaloMeId = $zaloDigits;
             if ($zaloMeId !== '' && strlen($zaloMeId) >= 9 && substr($zaloMeId, 0, 1) === '0') {
                 $zaloMeId = '84' . substr($zaloMeId, 1);
             } elseif ($zaloMeId !== '' && strlen($zaloMeId) >= 9 && substr($zaloMeId, 0, 2) !== '84') {
                 $zaloMeId = '84' . $zaloMeId;
             }
             $zaloHref = $zaloMeId !== '' ? 'https://zalo.me/' . $zaloMeId : route('lienHe');
         ...
         <div class="smart-contact" style="position:fixed; right:20px; bottom:20px; z-index:1050;">
             ...
             <div class="smart-actions" style="display:none;">
                 ...
                 <a href="{{ $zaloHref }}" target="_blank" rel="noopener"
                     class="smart-btn" aria-label="Chat Zalo"
                     style="display:inline-flex; align-items:center; justify-content:center; width:48px; height:48px; border-radius:50%; background:#0068FF; color:#fff; box-shadow:0 6px 16px rgba(0,0,0,0.15); font-weight:800; font-size:11px; letter-spacing:0.02em;">
                     Zalo
                 </a>
