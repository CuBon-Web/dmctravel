          ...
          <div class="main-bar">  
              ...
              <div class="nav-animation header-nav navbar-collapse collapse d-flex justify-content-end">
                ...
                <ul class=" nav navbar-nav">
                  <li><a href="{{route('home')}}">Trang chủ</a>
                  </li>
                  <li class="has-child">
                    <a href="javascript:;">Về chúng tôi</a>
                    <ul class="sub-menu">
                       <li><a href="{{route('aboutUs')}}">Giới thiệu</a></li>
                       <li><a href="{{route('fags')}}">Câu hỏi thường gặp</a></li>
                       <li><a href="{{route('feedback')}}">Đánh giá</a></li>
                    </ul>
                 </li>
                 <li class="has-child"><a href="javascript:;">DMC Dịch vụ</a>
                  <ul class="sub-menu">
                  ...
                  <li class="has-child"><a href="javascript:;">Địa điểm</a>
                      <ul class="sub-menu">
                       ...
                       <li>
                         <a href="javascript:;" class="gt-lang-toggle" aria-label="Language switcher" style="display:inline-flex; align-items:center; justify-content:space-between; min-width:60px; height:30px; border:2px solid #d8d8d8; border-radius:6px; color:#ffffff; padding:0 12px; font-size:12px;">
                           <span class="gt-lang-current">
                             <img width="20" height="20" src="{{url('frontend/images/flags/vi.png')}}" alt="VI">
                           </span>
