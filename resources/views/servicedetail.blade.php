			...
			<div class="banner-title-outer">
				...
				<div>
					<ul class="wt-breadcrumb breadcrumb-style-2">
						...
						<li><a href="{{route('serviceList',['slug'=>$detail_service->cate_slug])}}">Dịch vụ</a></li>
					...
					<div class="col-xl-4 col-lg-4 col-md-12 rightSidebar  m-b30">
						...
						<aside  class="side-bar">
									   ...
									   <div>
											...
											<div class="comment-respond trv-form" id="respond">
												...
												<div class="section-head trv-head-title-wrap left-position">
													<h2 class="trv-head-title"><span class="site-text-yellow">Đặt dịch vụ</span> </h2>
													<div class="trv-head-discription">Bạn có thể đặt dịch vụ bằng cách điền form bên dưới</div>
												</div>
												<!-- TITLE END-->
												...
												<form class="trv-cons-contact-form" method="post" action="{{ route('postBookService') }}">
												 ...
												 <input type="hidden" name="total" value="0">
													<div class="form-group">
														<input class="form-control" type="text" placeholder="Nhập tên của bạn" name="name" required>
													</div>
													<div class="form-group">
														<input class="form-control" type="text" placeholder="Nhập email của bạn" name="email">
													</div>
													<div class="form-group">
														<input class="form-control" type="text" placeholder="Nhập số điện thoại của bạn" name="phone" required>
													</div>
													
													<div class="form-group">
														<textarea  class="form-control" placeholder="Nhập ghi chú của bạn" name="note"></textarea>
													</div>
													<button type="submit" class="site-button butn-bg-shape">Đặt dịch vụ</button>
												</form>
							...
							<div class="widget trv-recent-posts">
								<div class="m-b20">
									<h4 class="widget-title">Dịch vụ liên quan</h4>
								</div>
...
<div class="breadcrumb-section" style="background-image: linear-gradient(270deg, rgba(0, 0, 0, .3), rgba(0, 0, 0, 0.3) 101.02%), url({{url('frontend/img/inner-banner-bg.png')}});">
 ...
 <div class="room-details-area pt-90 mb-90">
	<div class="container">
	   <div class="row g-xl-4 gy-5">
		  <div class="col-xl-8">
			 <h2>{{languageName($detail_service->name)}}</h2>
			 <div class="price-area">
				<h6>{{number_format(languageName($detail_service->price))}}{{getLanguage('tiente')}}</h6>
			 </div>
			 {!!languageName($detail_service->content)!!}
		  </div>
		  <div class="col-xl-4">
				   ...
				   <div class="tab-pane fade active show" id="v-pills-booking" role="tabpanel" aria-labelledby="v-pills-booking-tab">
					  <div class="sidebar-booking-form">
						<form action="{{route('postBookTour')}}" method="POST">
							...
							@php
								$arr = [];
								array_push($arr,$detail_service->id);
							@endphp
							<input type="text" hidden name="tour_id" value="">
							<input type="text" hidden name="service_id" value="{{ json_encode($arr)}}">
							<input type="text" hidden name="nguoilon" value="">
							<input type="text" hidden name="treem" value="">
							<input type="text" hidden name="total" value="{{number_format(languageName($detail_service->price))}}">
							...
							<div class="form-inner mb-30">
							   ...
							   <textarea placeholder="Write your quiry" name="note"></textarea>
							</div>
							<div class="form-inner">
							   <button type="submit" class="primary-btn1 two">Đăng Ký</button>
							</div>
						 </form>
					  </div>
				   </div>
			 ...
			 <div class="banner2-card">
				<img src="{{url('frontend/img/support-img.jpg')}}" alt="">
				   ...
				   <div class="banner2-content">
					  <div class="hotline-area">
						 ...
						 <div class="content">
							...
							<h6><a href="tel:{{$setting->phone1}}">{{$setting->phone1}}</a></h6>
						 </div>
					  </div>
				   </div>
				</div>
